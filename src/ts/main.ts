import { Settings, Song, Elements } from "./interfaces";
class MusicPlayer {
    elements: Elements;
    settings: Settings;
    queue: Song[];
    ...
    isPlaying = false;
    isMouseDown = false;
    constructor(containerId: string, settings: Settings) {
        this.elements.container = document.getElementById(containerId) as HTMLElement;
    ...
    createControls(): void {
        ...
        `;
        this.elements.song.title = document.getElementById("song-title") as HTMLElement;
        this.elements.song.artist = document.getElementById("song-artist") as HTMLElement;

        this.elements.playlistContainer = document.getElementById("player-playlist-container") as HTMLElement;
        this.elements.controls.progressBar = document.getElementById("player-progress-bar") as HTMLElement;
        this.elements.controls.progressBarContainer = document.getElementById("player-track-progress") as HTMLElement;
        this.elements.controls.timeCurrent = document.getElementById("player-time-current") as HTMLElement;
        this.elements.controls.timeTotal = document.getElementById("player-time-total") as HTMLElement;
        this.elements.controls.volumeControl = document.getElementById("player-volume-control") as HTMLInputElement;

        this.elements.controls.playPauseButton = document.getElementById("player-play-pause-button") as HTMLElement;
        this.elements.controls.stopButton = document.getElementById("player-stop-button") as HTMLElement;
        this.elements.controls.speedButton = document.getElementById("player-speed-button") as HTMLElement;
        this.elements.controls.shuffleButton = document.getElementById("player-shuffle-button") as HTMLElement;
        this.elements.controls.repeatButton = document.getElementById("player-repeat-button") as HTMLElement;
        this.elements.controls.nextButton = document.getElementById("player-next-button") as HTMLElement;
        this.elements.controls.prevButton = document.getElementById("player-prev-button") as HTMLElement;
        this.elements.controls.muteButton = document.getElementById("player-mute-button") as HTMLElement;
    ...
    addEventListeners(): void {
        ...
        document.querySelectorAll(".player-song").forEach((song) =>
            song.addEventListener("click", (e: any) => {
    ...
    updatePlaylist(): void {
        ...
        this.settings.songs.forEach((song: Song) => {
            ...
            audio.onloadedmetadata = () => {
                let elem = document.querySelector(`.player-song[data-song="${song.id}"]`) as HTMLElement;
    ...
    handleTrackbarClick(e: MouseEvent): void {
